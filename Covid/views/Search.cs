...
namespace Covid
{
    public partial class Search : Form
    {
        ...
        private void Search_Load(object sender, EventArgs e)
        {
            ...
            guna2DataGridView1.Rows[0].Cells[5].Value = "Pridaj";
            guna2DataGridView1.Rows[0].Cells[6].Value = "Možnosti";
            ...
            guna2DataGridView1.Rows[1].Cells[5].Value = "Pridaj";
            guna2DataGridView1.Rows[1].Cells[6].Value = "Možnosti";
            ...
            guna2DataGridView1.Rows[2].Cells[5].Value = "Pridaj";
            guna2DataGridView1.Rows[2].Cells[6].Value = "Možnosti";
            ...
            guna2DataGridView1.Rows[3].Cells[5].Value = "Pridaj";
            guna2DataGridView1.Rows[3].Cells[6].Value = "Možnosti";
            ...
            guna2DataGridView1.Rows[4].Cells[5].Value = "Pridaj";
            guna2DataGridView1.Rows[4].Cells[6].Value = "Možnosti";
        }
