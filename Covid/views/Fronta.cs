...
namespace Covid
{
    public partial class Fronta : Form
    {
        ...
        private void Fronta_Load(object sender, EventArgs e)
        {
            ...
            guna2DataGridView1.Rows[0].Cells[5].Value = "Pozitivný";
            guna2DataGridView1.Rows[0].Cells[6].Value = "Negativný";
            ...
            guna2DataGridView1.Rows[1].Cells[5].Value = "Pozitivný";
            guna2DataGridView1.Rows[1].Cells[6].Value = "Negativný";
            ...
            guna2DataGridView1.Rows[2].Cells[5].Value = "Pozitivný";
            guna2DataGridView1.Rows[2].Cells[6].Value = "Negativný";
            ...
            guna2DataGridView1.Rows[3].Cells[5].Value = "Pozitivný";
            guna2DataGridView1.Rows[3].Cells[6].Value = "Negativný";
            ...
            guna2DataGridView1.Rows[4].Cells[5].Value = "Pozitivný";
            guna2DataGridView1.Rows[4].Cells[6].Value = "Negativný";
        }
    }
}
